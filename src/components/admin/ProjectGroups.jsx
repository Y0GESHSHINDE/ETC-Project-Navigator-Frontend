...
function ProjectGroups() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-4">
      ...
      <h2 className="text-2xl font-bold">All Project Groups</h2>
      {/* Search Input */}
      <div className="mb-6 mt-6 ">
        ...
        />
        <button
          onClick={() => exportToCSV(groups, "project-groups")}
          ...
          <div className="bg-white rounded-lg max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="mt-4">
                  <h3 className="font-medium mb-2">Task Status Summary</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                    <div className="bg-green-100 text-green-800 px-3 py-2 rounded">
                      Approved:{" "}
                      {
                        selectedGroup.submissions.filter(
                          (s) => s.status === "approved"
                        ).length
                      }
                    </div>
                    ...
                    <div className="bg-gray-100 text-gray-600 px-3 py-2 rounded">
                      Total Tasks: {selectedGroup.taskStatus?.length || 0}
                    </div>
                  </div>
                </div>
